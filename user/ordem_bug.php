...
<section id="contact" class="home-section bg-white">
    ...
    <div class="form-group">
        ...
        <form method="post" class="form_envia" action="ordem.php?p=os">
			...
			<?php 
			if($user->ID == '4' OR $user->ID == '5' OR $user->ID == '1'){
			?>
       <div class="form-group">
			<div class="col-md-offset-2 col-md-8"><strong>Cliente:</strong><br/>
					<select name="pessoa" id="pessoa" class="form-control">
                    <option value=0>Escolha um tipo de cliente</option>
                    <option value="1" <?php if($os['pessoa'] == '1'){ echo "selected";} ?> >Pessoa Física</option>
                    <option value="2" <?php if($os['pessoa'] == '2'){ echo "selected";} ?>>Pessoa Jurídica</option>
       ...
       <div class="form-group">
			<div class="col-md-offset-2 col-md-8"><strong>Cliente:</strong><br/>
				<select name="cliente" id="cliente" class="form-control">
                 <?php geraCliente($os['pessoa'],$os['cliente'])?>
                </select>
